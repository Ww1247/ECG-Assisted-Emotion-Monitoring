 ...
 public:
      ...
      */
     explicit I2CDriver(int deviceAddress);
      ...
      */
     QVector<quint8> readBytes(quint8 reg, quint8 count);

 private:
     int i2cHandle_;       ///< I2C handle returned by pigpio
     int deviceAddress_;   ///< I2C device address
     QMutex i2cMutex_;     ///< Qt thread lock to ensure thread safety in I2C operations
